...
RotateTool::RotateTool(ViewPanel* panel, Type t) :
	...
	m_active(false), m_rotating(false), m_center(0, 0, 0),
...
void RotateTool::RenderAxis(unsigned int i) const
{
...
unsigned int RotateTool::GetAxisPick() const
{
...
float RotateTool::IntersectAxis(const glm::ivec2& mouse) const
{
...
bool RotateTool::HasVBO() const
{
	return m_vbo > 0 && glIsBuffer(m_vbo);
}

void RotateTool::BuildVBO()
{
	DeleteVBO();
